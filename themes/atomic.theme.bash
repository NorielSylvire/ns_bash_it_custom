export THEME_CLOCK_COLOR=$bold_blue

# Below is a modified version of the Atomic theme by lfelipe!
# I merely changed some colors because they seemed to be hardcoded, instead
# of relying on variables.
#
# I might extend this theme's functionality to support user defined variables
# for segment colors in the future.
...
function ___atomic_prompt_user_info() {
	...
	local info="${ILMagenta}\u${ILRed}@${ILGreen}\h"
